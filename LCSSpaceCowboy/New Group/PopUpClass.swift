...
class PopUpClass
{
    ...
    // - Always call the Destroy() function of a pop up to remove it
    ...
    // - in GameScene, if you need to see what the previous mode was (before the pop up), you can reach into currentPopUp.prevGameState to check. This will be important in how yes/no pop up results are handled.
